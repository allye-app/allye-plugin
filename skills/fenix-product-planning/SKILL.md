---
name: fenix-product-planning
description: Workflow for translating business requirements into epics, features, and stories in Fenix. Use when the user wants to plan a product, define scope, or create work item hierarchies.
version: "1.0"
category: workflow
---
...
- Use `parent_key` to reference an existing item (e.g., an epic already in Fenix)
...
- [ ] All items are created in Fenix with proper parent relationships

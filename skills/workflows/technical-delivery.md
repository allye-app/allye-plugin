...
- **Pick another story** → Back to Technical Planning (`fenix-technical-planning`)
- **Plan more features** → Back to Product Planning (`fenix-product-planning`)
